...
export function OptionGroupsEditor({ onChange, initialGroups = [] }: Readonly<OptionGroupsEditorProps>) {
    const { t } = useLingui();
    const multiGroupFormSchema = useMemo(() => createMultiGroupFormSchema(t), [t]);
